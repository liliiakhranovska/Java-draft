...
// starting from here I have just commented. TODO: need to be sure these lines can be removed:

//    @Override
//    public void start(Stage primaryStage) throws Exception {
//        final ChessBoardImpl chessBoardImpl = new ChessBoardImpl();
//        final Hardware chess  = HardwareFactory.getHardware();
//
//        final Group piecesOnBoard = new PiecesOnBoard();
//        chess.addFigure(chessBoardImpl);
